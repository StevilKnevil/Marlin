...
//#define SHOW_CUSTOM_BOOTSCREEN // Stevil Knevil

// Show the bitmap in Marlin/_Statusscreen.h on the status screen.
//#define CUSTOM_STATUS_SCREEN_IMAGE // Stevil Knevil
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  32 // Stevil Knevil
    #define DEFAULT_Ki  4.25 // Stevil Knevil
    #define DEFAULT_Kd  60 // Stevil Knevil
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 85 // Stevil Knevil
  #define DEFAULT_bedKi 15 // Stevil Knevil
  #define DEFAULT_bedKd 340 // Stevil Knevil
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 2500, 100, 5000 } // Stevil Knevil
 ...
 */
#define DEFAULT_ACCELERATION                  1200  // X, Y, Z ... and E acceleration for printing moves // Stevil Knevil
#define DEFAULT_RETRACT_ACCELERATION          1200  // E acceleration for retracts // Stevil Knevil
 ...
 */
//#define CLASSIC_JERK // Stevil Knevil
...
#define NOZZLE_PARK_FEATURE // Stevil Knevil
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MAX_POS), 20 } // Stevil Knevil
